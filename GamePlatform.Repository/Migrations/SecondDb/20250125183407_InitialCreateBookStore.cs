    ...
    public partial class InitialCreateBookStore : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameInCart", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GameInCart_Game_GameId",
                        column: x => x.GameId,
                        principalTable: "Game",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GameInCart_ShoppingCart_ShoppingCartId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameInOrder", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GameInOrder_Game_GameId",
                        column: x => x.GameId,
                        principalTable: "Game",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GameInOrder_Order_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameInCart_GameId",
                table: "GameInCart",
                column: "GameId");

            migrationBuilder.CreateIndex(
                name: "IX_GameInCart_ShoppingCartId",
                table: "GameInCart",
                column: "ShoppingCartId");

            migrationBuilder.CreateIndex(
                name: "IX_GameInOrder_GameId",
                table: "GameInOrder",
                column: "GameId");

            migrationBuilder.CreateIndex(
                name: "IX_GameInOrder_OrderId",
                table: "GameInOrder",
                column: "OrderId");
